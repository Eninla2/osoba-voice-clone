...
# Multi-user keys — set USER_KEYS in Render as comma-separated values
# e.g: osoba-001,osoba-002,osoba-003
# Master key (OSOBA_SECRET) always works regardless of USER_KEYS
...
def is_valid_key(key: str) -> bool:
    ...
    if not SECRET_KEY and not USER_KEYS:
        return True
    return False
