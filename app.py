...
# ── 75 VERIFIED Edge TTS English voices (en-KE removed — not supported) ──
VOICES = {
    # US MALE
    ...
    # AFRICAN — TANZANIAN 🇹🇿
    "en-TZ-DaudiNeural":         "Tanzanian Male 🇹🇿 — Warm, Deep",
    "en-TZ-ImaniNeural":         "Tanzanian Female 🇹🇿 — Soft, Melodic",
    # INDIAN 🇮🇳
...
print(f"[OSOBA v{VERSION}] READY — {len(VOICES)} voices loaded")
...
def root():
    return (
        ...
        f"<p style='color:#aaa'>{len(VOICES)} verified voices loaded</p>"
...
async def generate(request: Request):
    ...
    try:
        ...
        print(f"[OSOBA ERROR] voice={voice} error={e}")
